//         1 display 1 hide
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function goToSlide(newIndex) {
                ...
                const direction = newIndex > currentSlideIndex || (newIndex === 0 && currentSlideIndex === totalSlides - 1) 
                    ? 'next'
                    : 'prev';
            ...
            slides.forEach((slide, i) => {
                ...
                dot.classList.add('dot', 'h-2', 'rounded-full', 'cursor-pointer', 'transition-all', 'inline-block', 'mx-1');
